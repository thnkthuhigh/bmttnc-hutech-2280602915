...
class WebSocketServer:
    ...
    def connect_and_read(self):
        print("Reading..")
        tornado.websocket.websocket_connect(url=f"ws://localhost:8888/websocket/",callback=self.maybe_retry_connection,
                                            on_message_callback=self.on_message,ping_interval=10,ping_timeout=30)
...
def main():
    ...
    client= WebSocketServer(io_loop)
